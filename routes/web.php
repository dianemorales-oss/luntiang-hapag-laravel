...
Route::middleware(['customer.auth'])->group(function(){
    ...
    Route::get('/notifications/api', [App\Http\Controllers\CustomerNotificationController::class, 'apiList'])->name('customer.notifications.api');
    Route::post('/notifications/{id}/read', [App\Http\Controllers\CustomerNotificationController::class, 'markRead'])->name('customer.notifications.read');
    Route::post('/notifications/mark-all-read', [App\Http\Controllers\CustomerNotificationController::class, 'markAllRead'])->name('customer.notifications.markAllRead');
    Route::get('/notifications/{id}/open', [App\Http\Controllers\CustomerNotificationController::class, 'open'])->name('customer.notifications.open');
});
