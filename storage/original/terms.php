...
<head>
  ...
  <title>Terms of Service | Luntiang H.A.P.A.G.</title>
...
<body class="bg-[#f4faf5] text-[#1a2e1c] min-h-screen flex flex-col">
  ...
  <main class="flex-1 max-w-3xl w-full mx-auto px-6 py-16">
    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-10">
      ...
      <h1 class="font-black text-3xl font-semibold text-[#1a2e1c] mb-4">Terms of Service</h1>
      <div class="text-[#5a7a5c] text-[15px] leading-relaxed space-y-4">
        <p>By using Luntiang H.A.P.A.G., you agree to the following terms. Please read them carefully before creating an account or submitting a request.</p>
